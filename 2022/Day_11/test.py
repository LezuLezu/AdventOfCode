#  by https://www.reddit.com/r/adventofcode/comments/zifqmh/comment/iztxw5i/?utm_source=share&utm_medium=web2x&context=3
"""
...
all_monkeys = []
monkey = None
with open("2022/Day_11/Data.txt", 'r') as f:
# with open("2022/Day_11/TestData.txt", 'r') as f:
    for line in f:
